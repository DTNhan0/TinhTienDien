...
public class PanelActionDSCongToDien extends javax.swing.JPanel {
    public PanelActionDSCongToDien() {
        initComponents();
    }

    public void initEvent(TableActionEvent event, int row, MainAdminView mainAdminView, DSCongToDienMainView dsctdmv) {
