...
public class PanelActionThongTinGhiDien extends javax.swing.JPanel {
    public PanelActionThongTinGhiDien() {
        initComponents();
    }

    public void initEvent(TableActionEventThongTinGhiDien event, int row, MainAdminView mainAdminView, ThongTinGhiDienMainView ttgdmv) {
        buttonThuong1.addActionListener(new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent ae) {
                event.onTTGhiDienView(row, mainAdminView, ttgdmv);
            }
        });
    }
