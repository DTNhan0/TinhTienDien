...
public class PanelActionThongTinGhiDienLow extends javax.swing.JPanel {
    public PanelActionThongTinGhiDienLow() {
        initComponents();
    }

    public void initEvent(TableActionEventThongTinGhiDienLow event, int row, MainAdminView mainAdminView, ThongTinGhiDienSubHighView ttgdshv) {
        buttonThuong1.addActionListener(new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent ae) {
                event.onTTGhiDienView(row, mainAdminView, ttgdshv);
            }
        });
    }
