...
public class FilterLoaiDateDSCHDialog extends javax.swing.JDialog {
    ...
    public FilterLoaiDateDSCHDialog(MainAdminView mainAdminView, DSCongToDienMainView dSCongToDienMainView, boolean modal) {
        initComponents();
    ...
    private void OkBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OkBtActionPerformed
        ...
        if(NgayCkb.isSelected()){
            DSChuHo.Filter((String)NgayCb.getSelectedItem(), 1, 1, DsCongToDienMainView.getBangDSChuHo());
            check = true;
        }
        if(ThangCkb.isSelected()){
            DSChuHo.Filter((String)ThangCb.getSelectedItem(), 2, 1, DsCongToDienMainView.getBangDSChuHo());
            check = true;
        }
        if(NamCkb.isSelected()){
            DSChuHo.Filter(String.valueOf(NamCb.getYear()), 3, 1, DsCongToDienMainView.getBangDSChuHo()); 
            check = true;
        }
        if(check)
