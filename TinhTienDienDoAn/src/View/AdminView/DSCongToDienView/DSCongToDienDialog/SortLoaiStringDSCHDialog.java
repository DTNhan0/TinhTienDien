...
public class SortLoaiStringDSCHDialog extends javax.swing.JDialog {
    ...
    public SortLoaiStringDSCHDialog(MainAdminView mainAdminView, DSCongToDienMainView dSCongToDienMainView, boolean modal) {
        initComponents();
        this.MainAdminview = mainAdminView;
        this.DsCongToDienMainView = dSCongToDienMainView;
    ...
    public void SortDialog(int loaiSapXep){
        Object selected = DsCongToDienMainView.getSapXepCkb().getSelectedItem();
        if(selected.equals("Theo CCCD")){
            DSChuHo.Sorting(loaiSapXep, 1, DsCongToDienMainView.getBangDSChuHo());
        }else if(selected.equals("Theo họ và tên")){
            DSChuHo.Sorting(loaiSapXep, 2, DsCongToDienMainView.getBangDSChuHo());                
        }else if(selected.equals("Theo địa chỉ")){
            DSChuHo.Sorting(loaiSapXep, 3, DsCongToDienMainView.getBangDSChuHo());                
        }else if(selected.equals("Theo SĐT")){
            DSChuHo.Sorting(loaiSapXep, 4, DsCongToDienMainView.getBangDSChuHo());                
        }else if(selected.equals("Theo Account")){
            DSChuHo.Sorting(loaiSapXep, 5, DsCongToDienMainView.getBangDSChuHo());                
        }else if(selected.equals("Theo ngày sinh")){
            DSChuHo.Sorting(loaiSapXep, 6, DsCongToDienMainView.getBangDSChuHo());                
        }          
    }
