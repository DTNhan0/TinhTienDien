...
public class GhiDienDialog extends javax.swing.JDialog {
    ...
    public GhiDienDialog(MainAdminView mainAdminView, ThongTinGhiDienSubLowView ttgdslv, boolean modal) {
        initComponents();
    ...
    private void OkBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OkBtActionPerformed
        if(TotalDienTf.getText().replaceAll(" ", "").equals("")){
        ...
        }else if(CheckingDataExist.CheckExistDateE_Meter_Details(NgayGhiDienJDate.getDate(), null, lstE_MeterDetails)){
            ...
            int confirm = JOptionPane.showConfirmDialog(
                this,
                "Bạn có chắc muốn thêm dữ liệu ghi điện không?",
            "Xác nhận thêm",
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                try {
                    ...
                    e_Meter_Details.setCreating_Date(formattedDate);                    
                } catch (ParseException e) {
                    e.printStackTrace();
                
                }             
                e_Meter_Details.setID_E_Meter(e_Meters.getID_E_Meter());
                e_Meter_Details.setCurrent_Num(Integer.parseInt(TotalDienTf.getText()));
                e_Meter_Details.setID_Staff_Input(staffs.getID_Staff());
                e_Meter_Details.setID_E_Meter_Detail(0);
                
                try{
                    DSThongTinGhiDien.Add(e_Meter_Details);
