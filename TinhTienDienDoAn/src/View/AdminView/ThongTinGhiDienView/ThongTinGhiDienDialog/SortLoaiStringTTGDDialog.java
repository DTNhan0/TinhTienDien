...
public class SortLoaiStringTTGDDialog extends javax.swing.JDialog {
    private MainAdminView MainAdminview;
    private ThongTinGhiDienMainView thongTinGhiDienMainView;
    
    public SortLoaiStringTTGDDialog(MainAdminView mainAdminView, ThongTinGhiDienMainView ttgdmv, boolean modal) {
        initComponents();
    ...
    public void SortDialog(int loaiSapXep){
        Object selected = thongTinGhiDienMainView.getSapXepCkb().getSelectedItem();
        if(selected.equals("Theo CCCD")){
            DSNhanVien.Sorting(loaiSapXep, 1, thongTinGhiDienMainView.getBangDSNhanVien());
        }else if(selected.equals("Theo họ và tên")){
            DSNhanVien.Sorting(loaiSapXep, 2, thongTinGhiDienMainView.getBangDSNhanVien());                
        }else if(selected.equals("Theo địa chỉ")){
            DSNhanVien.Sorting(loaiSapXep, 3, thongTinGhiDienMainView.getBangDSNhanVien());                
        }else if(selected.equals("Theo SĐT")){
            DSNhanVien.Sorting(loaiSapXep, 4, thongTinGhiDienMainView.getBangDSNhanVien());                
        }else if(selected.equals("Theo Account")){
            DSNhanVien.Sorting(loaiSapXep, 5, thongTinGhiDienMainView.getBangDSNhanVien());                
        }else if(selected.equals("Theo ngày sinh")){
            DSNhanVien.Sorting(loaiSapXep, 6, thongTinGhiDienMainView.getBangDSNhanVien());                
        }          
    }
