...
import Component.ThongTinGhiDienComponent.TableActionCellEditorThongTinGhiDien;
import Component.ThongTinGhiDienComponent.TableActionCellRenderThongTinGhiDien;
import Component.ThongTinGhiDienComponent.TableActionEventThongTinGhiDien;
...
public class ThongTinGhiDienMainView extends javax.swing.JPanel {
    private Staffs St;
    ...
    public void ShowThongTinTuDBS(BangDanhSach bangDS){
        ...
        TableActionEventThongTinGhiDien event = new TableActionEventThongTinGhiDien() {
            @Override
            public void onTTGhiDienView(int row, MainAdminView mainAdminView, ThongTinGhiDienMainView ttgdmv) {
        ...
        for(Staffs st : dsStaffs){
            if(st.getRoleStaff() == 0){
                ...
                Object[] rowData = {
                    ...
                    st.getAccount_Password(), "Ghi điện"
                };
                model.addRow(rowData);
            }                
        }
   
        bangDS.getColumnModel().getColumn(8).setCellRenderer(new TableActionCellRenderThongTinGhiDien());
        bangDS.getColumnModel().getColumn(8).setCellEditor(new TableActionCellEditorThongTinGhiDien(event, MainAdminview, this));
    ...
    private void initComponents() {
        ...
        BangDSNhanVien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CCCD", "Họ và tên", "Ngày sinh", "Địa chỉ", "SĐT", "Account", "Password", "Vai trò", "Công tơ điện"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.Object.class
            };
    ...
    private void LamMoiBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LamMoiBtActionPerformed
        MainAdminview.setForm(new ThongTinGhiDienMainView(MainAdminview));
    ...
    private void LocBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LocBtActionPerformed
        ...
        if(selected == null){
            ...
            FilterLoaiDateTTGDDialog filterLoaiDateTTGDDialog = new FilterLoaiDateTTGDDialog(this.MainAdminview, this, true);
            filterLoaiDateTTGDDialog.setVisible(true);           
        }
    ...
    private void SapXepBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SapXepBtActionPerformed
        ...
        if(selected == null){
            ...
            SortLoaiStringTTGDDialog sortLoaiStringTTGDDialog =new SortLoaiStringTTGDDialog(this.MainAdminview, this, true);
            sortLoaiStringTTGDDialog.setVisible(true);  
        }
