...
public class SortLoaiStringTTNXDialog extends javax.swing.JDialog {
    private MainAdminView MainAdminview;
    private ThongTinNhapXuatMainView thongTinNhapXuatMainView;
    
    public SortLoaiStringTTNXDialog(MainAdminView mainAdminView, ThongTinNhapXuatMainView ttnxmv, boolean modal) {
        initComponents();
    ...
    public void SortDialog(int loaiSapXep){
        Object selected = thongTinNhapXuatMainView.getSapXepCkb().getSelectedItem();
        if(selected.equals("Theo CCCD")){
            DSNhanVien.Sorting(loaiSapXep, 1, thongTinNhapXuatMainView.getBangDSNhanVien());
        }else if(selected.equals("Theo họ và tên")){
            DSNhanVien.Sorting(loaiSapXep, 2, thongTinNhapXuatMainView.getBangDSNhanVien());                
        }else if(selected.equals("Theo địa chỉ")){
            DSNhanVien.Sorting(loaiSapXep, 3, thongTinNhapXuatMainView.getBangDSNhanVien());                
        }else if(selected.equals("Theo SĐT")){
            DSNhanVien.Sorting(loaiSapXep, 4, thongTinNhapXuatMainView.getBangDSNhanVien());                
        }else if(selected.equals("Theo Account")){
            DSNhanVien.Sorting(loaiSapXep, 5, thongTinNhapXuatMainView.getBangDSNhanVien());                
        }else if(selected.equals("Theo ngày sinh")){
            DSNhanVien.Sorting(loaiSapXep, 6, thongTinNhapXuatMainView.getBangDSNhanVien());                
        }          
    }
